...
const PerfilDeEvaluador: React.FC = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const userResponse = await fetch(`https://egresados.it2id.cc/api/users/${idToFetch}`, {
                method: 'GET',
                headers: {
            ...
            const profileResponse = await fetch(`https://egresados.it2id.cc/api/professional-profiles/user/${idToFetch}`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${userToken}`,
                    'Content-Type': 'application/json',
            ...
            if (profileResponse.ok) {
                ...
                const createProfileResponse = await fetch(`https://egresados.it2id.cc/api/professional-profiles`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${userToken}`,
                        'Content-Type': 'application/json',
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const profileUpdateResponse = await fetch(`https://egresados.it2id.cc/api/professional-profiles/user/${idToUpdate}`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${userToken}`,
                    'Content-Type': 'application/json',
