...
const EvaluacionProyecto: React.FC = () => {
    ...
    useEffect(() => {
        const fetchProjectAndUserData = async () => {
            ...
            try {
                ...
                // Fetch project data
                const projectResponse = await fetch(`http://188.68.59.176:8000/projects/${evaluationId}`, {
                    headers: headers,
                });
                ...
                const evidenceResponse = await fetch(`http://188.68.59.176:8000/evidences/project/${projectData.id}`, {
                    headers: headers,
                });
                ...
                const userResponse = await fetch(`http://188.68.59.176:8000/users/${projectData.egresado_id}`, {
                    headers: headers,
                });
                if (!userResponse.ok) {
    ...
    const handleEnviarReporte = async () => {
      ...
      try {
        const response = await fetch('http://188.68.59.176:8000/evaluations', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
